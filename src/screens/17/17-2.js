...
import Img1 from '../../assets/images/stanford.jpg';
import Img2 from '../../assets/images/novogang.jpg';
import Img3 from '../../assets/images/intercon.jpg';
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{ display: "flex" }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'inline-block', fontFamily: "Dohyeon", display: "block", margin: "0 auto" }}>
                            <div style={{ fontSize: "26px", marginTop: "15px", marginBottom: "15px" }}>
                                노보텔 앰배서더 강남
                            </div>
