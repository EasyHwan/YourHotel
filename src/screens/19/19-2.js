...
import Img1 from '../../assets/images/mondrian.jpg';
import Img2 from '../../assets/images/novotel.jpg';
import Img3 from '../../assets/images/novotelresi.png';
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{ display: "flex" }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'inline-block', fontFamily: "Dohyeon", display: "block", margin: "0 auto" }}>
                            <div style={{ fontSize: "22px", marginTop: "18px", marginBottom: "18x" }}>
                                노보텔 앰배서더 서울 용산
                            </div>
                    ...
                    <div style={{
                        ...
                        <div style={{ display: 'inline-block', fontFamily: "Dohyeon", display: "block", margin: "0 auto" }}>
                            <div style={{ fontSize: "20px", marginTop: "5px", marginBottom: "5px" }}>
